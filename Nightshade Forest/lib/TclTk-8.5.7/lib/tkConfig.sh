...
# installed.
TK_PREFIX='/cygdrive/c/Programming/TclTk-8.5.7'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/cygdrive/c/Programming/TclTk-8.5.7'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/cygdrive/C/Programming/tk8.5.7-build -ltk85'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/cygdrive/c/Programming/TclTk-8.5.7/lib -ltk85'
...
# compiled.
TK_SRC_DIR='/cygdrive/C/Programming/tk8.5.7'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/cygdrive/C/Programming/tk8.5.7-build -ltkstub85'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/cygdrive/c/Programming/TclTk-8.5.7/lib -ltkstub85'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/cygdrive/C/Programming/tk8.5.7-build/libtkstub85.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/cygdrive/c/Programming/TclTk-8.5.7/lib/libtkstub85.a'
